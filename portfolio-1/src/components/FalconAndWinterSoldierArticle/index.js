...
export default class FalconAndWinterSoldierPost extends React.Component {
    ...
    constructor(props) {
        ...
        this.post = {
            ...
            article: "Going into Falcon and the Winter Soldier I thought my opinion had been swayed toward normal 'Marvel action movie. I thought this because of the pace that WandaVision had set being very different from normal Marvel projects and much slower story based. But now that WandaVision is over, I want more of that type of story. There was so much character development and twists and turns througout the series, I would love to see that in Falcon and the Winter Soldier. While I do love my blow stuff up, out there typical Marvel projects, I feel like that could be saved more for the movie side of things.",
        }
        this.state = {
            reported: false,
        };
